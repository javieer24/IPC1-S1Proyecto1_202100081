...
public class InterfacesGraficas {
    ...
    public static void generarHtmlGuia(String codigo){
        ...
        try {
            ...
            escritor.println("<h1>Código Paquete: "+codigo+"</h1>\n");
    ...
    public static Object[][] devolverDatosRegionesOrdenadas(){
        ...
        Object[][] matrizRegiones;
        matrizRegiones = new Object[regionesOrdenadas.size()][3];
        for(int i=0;i<regionesOrdenadas.size();i++){
            matrizRegiones[i][0]=regionesOrdenadas.get(i).getCodigoRegion();
            matrizRegiones[i][1]=regionesOrdenadas.get(i).getNombreRegion();
            matrizRegiones[i][2]=regionesOrdenadas.get(i).getCantidadEnvios();
        }
        return matrizRegiones;
    }
    ...
    public static ArrayList<Usuario> ordenarUsuariosPorEnvios() {
        ...
        ArrayList<Usuario> usuariosOrdenados = new ArrayList<Usuario>(usuarios);
